# generalised (badly hacked) version of Amy McQuillan's ACF code
...
DIR = '/Users/angusr/Python/GProtation'
...
# id list is a list of ids
def corr_run(time, flux, id_list, tr_out = False, tr_type = None):
...
#     pylab.title('ID: C27b_lc', fontsize = 16)
    ...
    pylab.savefig('%s/acf/%s_pgram.png' \
                  %(DIR, id_list))
