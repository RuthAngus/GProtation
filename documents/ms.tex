...
who use the ACF method described in \citet{Mcquillan2013}.
...
for all \naigrain\ stars, and are therefore the only team with which we
compare results from this paper.
The other participating groups chose to report only the period measurements
they were confident in and are likely to have omitted large outliers.
So, in order to test our results against an additional commonly used
