...
% period_hist.pdf
% demo_lc.pdf
% comparison_acfprior_03_10.pdf
% comparison_noprior_02_13.pdf
% corner_plot.pdf
% demo_ACF.pdf
% compare_acf.pdf
% compare_pgram_filtered_35.pdf
% comparison_koi_01_23.pdf
...
\begin{figure}
\begin{center}
\includegraphics[width=\columnwidth, clip=true]{koi_lc_demo.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=\columnwidth, clip=true]{period_hist.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=\columnwidth, clip=true]{demo_lc.pdf}
...
\begin{figure*}
\begin{center}
% \includegraphics[width=6in, clip=true]{compare_mcmc.pdf}
\includegraphics[width=6in, clip=true]{comparison_acfprior_03_10.pdf}
...
\begin{figure*}
\begin{center}
\includegraphics[width=6in, clip=true]{comparison_noprior_02_13.pdf}
\caption{The `true' rotation periods used to generate \naigrain\
simulated light curves vs the rotation periods measured using the GP
...
\begin{figure*}
\begin{center}
\includegraphics[width=6in, clip=true]{corner_plot.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=\columnwidth, clip=true]{demo_ACF.pdf}
...
\begin{figure*}
\begin{center}
\includegraphics[width=6in, clip=true]{compare_acf.pdf}
\caption[ACF results.]
...
uncertainty is a noisy estimate of the true uncertainty.
}
...
\begin{figure*}
\begin{center}
% \includegraphics[width=6in, clip=true]{compare_pgram.pdf}
\includegraphics[width=6in, clip=true]{compare_pgram_filtered_35.pdf}
...
\begin{center}
    ...
    for \nkoi\ \Kepler\ objects of interest. The full table is available online.}
\begin{tabular}{lcccc}
    KOI number & Period & KIC T$_{\mathrm{eff}} $ & KIC $\log(g)$ &
    KIC $[$Fe$/$H$]$ \\
    & (days) & (K) & dex & dex \\
    \hline
...
\begin{figure*}
\begin{center}
\includegraphics[width=6in, clip=true]{comparison_koi_01_23.pdf}
