...
\begin{itemize}
    \item The likelihood evaulation is computationally expensive;
...
Evaluating this likeihood for a large number of points can be computationally
...
potentially requiring modifications to these priors 
...
model would give better results'' is worth saying...}
