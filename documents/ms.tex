...
In order to test the GP method we attempted to measure the rotation periods of
...
listed in table \ref{tab:simulation_parameters}.
...
Once simulated, the light curves were added to real, quiet \kepler\ light
curves --- with no obvious astrophysical variability --- in order to preserve
the noise properties of the time series.
