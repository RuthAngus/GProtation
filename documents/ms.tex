...
We consider it likely that such alterations would produce only slight changes
to the results, for example because peaks in the LS periodograms of Kepler
light curves are usually narrow.
