...
Haywood2015, Evans2015, Rajpaul2015, Czekala2015, Rajpaul2016, Aigrain2016}.
...
We use this QP kernel function, defined in equation \ref{eqn:QP} to produce
the GP model that fits the \Kepler\ light curve in in Figure
\ref{fig:GP_example}.
...
--- smaller than the results produced by the GP method.
...
The MRD of the periodogram-recovered periods is \percentpgramMAD\%,
significantly worse than the ACF and GP methods (see table \ref{tab:MADs} for
a side-by-side comparison with the other methods).
The LS periodogram method drastically overestimates many rotation periods
because long-term trends unrelated to rotation can cause excess power at long
periods.
