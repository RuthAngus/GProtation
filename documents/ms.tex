...
of the individual sections (all using the same parameters ${\bm \theta}$).  This reduces
...
on the non-period parameters (e.g., see Section \ref{sec:kepler}).  
For period, we tried two different methods:
...
>>>>>>> 265508362e5e7a01a39bdd616c754c276059397c
