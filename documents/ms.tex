...
The code used to implement this new method is available at
...
transpositions \citep[see, \eg][]{Carter2010}, for the wavelet method.
...
sampled) and not nearly the case for most ground-based measurements, such as
...
In this work, we introduce an {\it effective} model for rotationally modulated
...
Similarly, the uncertainty, calculated from the 16th and 84th percentiles of
the posterior PDF, is not exactly the standard deviation of a physical
rotation period.
