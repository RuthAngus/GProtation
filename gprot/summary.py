...
def corner_plot(samples, true_period=None, **kwargs):
    ...
    if len(true_period)==2:
        ...
        fig = corner.corner(samples, labels=GPRotModel.param_names, range=rng, **kwargs)
        axes = fig.get_axes()
        ...
        fig = corner.corner(samples, labels=GPRotModel.param_names, 
