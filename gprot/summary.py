...
def corner_plot(basename, true_period=None, **kwargs):
    ...
    if len(true_period)==2:
        P1, P2 = true_period
        rng = [0.999, 0.999, 0.999, 0.999, (min(df['ln_period'].min(), P1),
                                            max(df['ln_period'].max(), P2))]
        ...
        rng = [0.999, 0.999, 0.999, 0.999, (min(df['ln_period'].min(), true_period),
                                            max(df['ln_period'].max(), true_period))]
